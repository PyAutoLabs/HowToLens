...
If any code in this script is unclear, refer to the `autolens_workspace/*/weak/simulator.ipynb` notebook.
"""
...
`via_tracer_from` evaluates the tracer's shear at the supplied (y, x) positions and adds the shape noise.
"""
...
"""
The dataset can be viewed in the folder `dataset/weak_lensing/simple`.
"""
